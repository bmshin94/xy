...
def xy_docs_logo() -> rx.Component:
    ...
    return rx.el.svg(
        ...
        rx.el.path(d="M108 7V10H113H115V7H108Z", fill=wordmark_fill),
        rx.el.path(d="M115 7H118V1H115V7Z", fill=wordmark_fill),
        rx.el.path(d="M105 1V7H108V1H105Z", fill=wordmark_fill),
        rx.el.path(d="M110 10V16H113V10H110Z", fill=wordmark_fill),
